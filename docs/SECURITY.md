...
Secrets belong in Script Properties or GitHub environment secrets, never Sheets/client JavaScript/Git. Resource IDs are withheld from ordinary bootstrap data. Audit records avoid file contents and credentials.
